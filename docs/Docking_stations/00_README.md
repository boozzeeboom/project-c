...
- ✅ **`DockPadVisualMarker` v2** — реализован (2026-07-12). Holographic-маркеры с 7 состояниями, сетевая синхронизация через `PadStateSync`. Тикет `T-DOCK-14` закрыт. Подробно: `11_VISUAL_MARKERS_PLAN.md`.
