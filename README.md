...
**Version:** 0.0.11 | **Stage:** Early Pre-Alpha (прототип ядра)
...
**Ветка:** `qwen-gamestudio-agent-dev` | **Версия:** `v0.0.11-disconnect-fix`
...
- Сетевой мультиплеер (Host + Client, синхронизация движения, камеры, инвентаря, кораблей)
- Кооп-корабли (несколько игроков, усреднение ввода)
- Disconnect UI (кнопка по центру, обработка обрывов соединения)
