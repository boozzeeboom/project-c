...
- Следующие обязательные части интеграции: authenticated persistent identity до spawn, saved-checkpoint lookup/restore-plan и genuine source G с native content/frame/AOI readiness; ship/ParentLocal composition, NPC/ship/RPC DTO и disconnect/final-save lifecycle. Нужны user acceptance native storage B и scheduling/performance capture C. Authoring/baking source bindings, reviewed catalog, spatial/replacement/exclusion/DDOL/loading bridges T-FO06–08 и dirty/missing-component/uninspected scope H остаются открытыми. I static/service subset и A–C persistence helpers НЕ завершают native gameplay, MMO streaming или distributed recovery. Prefab/scene activation, полный T-FO04/T-FO05 и T-FO06–09 не приняты. Runtime floating origin выключен, устранение микротряски не подтверждено.
