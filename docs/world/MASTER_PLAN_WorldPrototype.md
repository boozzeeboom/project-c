...
|------|--------|-------|-----------|
| **A: Ландшафт** | 8 | ~13ч | 5 массивов, 28 пиков, 15 хребтов, 9 ферм, 5 городов |
| **B: Облака** | 6 | ~7.5ч | Завеса, кумуло-дождевые, 3 слоя, коридоры, гарантии |
| **ИТОГО** | **14** | **~20.5ч** | Полный прототип мира |
...
|------|---------|-----------|
| Города выше глобального коридора | 🔴 ВЫСОКИЙ | Сессия A1: обновить global max до 95.0 |
...
#### Сессия B3: Обновление слоёв
**Вход:** WorldLandscape_Design.md §5.2, текущие CloudLayerConfig
**Выход:** Обновлённые CloudLayerConfig (Upper 70-90, Middle 40-70, Lower 15-40), CloudClimateTinter, GPU Instancing
...
```
Y = 95+    ════════════════════════════════  ВЫСОТНЫЙ КОРИДОР (обновлённый)
            Корабли с высотной модификацией

Y = 90     ────────────────────────────────  Верхний слой облаков (Upper)
            ════════════════════════════════  Кумуло-дождевые наковальни

Y = 70     ╔═══════════════════════════════  СНЕЖНЫЕ ВЕРШИНЫ
            ║   Города: Примум (88.48), Тертиус (69.62)
Y = 60     ║   Города: Квартус (61.90), Кибо (58.95)

Y = 44.5   ╠═══════════════════════════════  СТАРЫЙ global max (ОБНОВИТЬ до 95.0)

Y = 40-70  ║   MIDDLE слой облаков
            ║   Города: Секунд (48.08)
Y = 40     ║   ФЕРМЫ: Y=25-45 (некоторые В облаках!)

Y = 15-40  ║   LOWER слой облаков (плотные)
            ║   Фермы: Эверест 110 (Y=30), Дон 1010 (Y=25)

Y = 14     ────────────────────────────────  Зона предупреждения завесы
Y = 12     ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  ЗАВЕСА (Y=12, #2d1b4e, молнии)
Y = 8-12   ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  КРАЕВАЯ ЗОНА
Y = 0-8    ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓  ПОД ЗАВЕСОЙ (смертельно)
