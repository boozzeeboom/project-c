...
1. **Настройка репозитория:**
   ...
   - ✅ `.gitignore` игнорирует тяжёлые папки: `Library/`, `Temp/`, `Logs/`, `UserSettings/`
...
**Осталось сделать:**
- [ ] Выбрать и добавить сетевой стек (рекомендуется **Mirror Networking**)
- [ ] Настроить Git LFS (уже включен для PNG и других больших файлов)
...
Или используйте файл с инструкциями:

```
Прочитай README_QWEN.md и продолжи работу
```
