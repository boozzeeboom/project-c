...
| `ITERATIONS.md` | Лог итерации T-LOD01: что реализовано, отклонения от плана, LOC-ключи, ручной чек-лист. |
...
- [x] T-LOD01 — реализация (код + конфиг, Console 0 errors; см. `ITERATIONS.md`)
- [ ] Ручная проверка пользователем (Play, скрины 3 пресетов, F8/F9, Profiler) + калибровка чисел в конфиге
- [ ] LOC-проход UI_Table (ключи в `ITERATIONS.md`)
