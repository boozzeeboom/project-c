// CloudGhibli_OutlineV3.shader — Ghibli cloud with proper silhouette outline
// Uses depth-only edge detection at silhouette (not internal edges)
// Gradient lighting + rim glow + vertex displacement

Shader "ProjectC/CloudGhibli_OutlineV3"
{
    Properties
    {
        [Header(Base Color)]
        ...
        [Header(Outline - Silhouette Only)]
        _OutlineColor ("Outline Color", Color) = (0.18, 0.11, 0.31, 1.0)
        _OutlineThickness ("Outline Thickness", Range(0.0001, 0.05)) = 0.01
        _OutlineEdgeThreshold ("Edge Threshold", Range(0.001, 0.1)) = 0.01
    ...
    SubShader
    {
        ...
        // ============================================
        // OUTLINE PASS - Inverted Hull (proper method)
        // ============================================
        Pass
        {
