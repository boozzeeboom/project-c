...
- Следующие обязательные части интеграции: genuine prepared-content/global-persistence source G, authoring/baking реальных source bindings и reviewed catalog, spatial/replacement/exclusion/DDOL/loading bridges в согласовании с T-FO05–08. Review dirty/missing-component/uninspected scope H остаётся открытым. I full-preload static/service subset НЕ завершает native gameplay, MMO streaming или distributed retire/recovery. Prefab/scene activation и T-FO05–09 ещё не выполнены; полный T-FO04 не принят. Runtime floating origin выключен, устранение микротряски не подтверждено.
