...
|------|---------|-----------|
| Города выше глобального коридора | 🔴 ВЫСОКИЙ | Сессия A1: обновить global max до 9500 |
| Масштаб координат: Y в метрах, XZ в 1:2000 | 🔴 ВЫСОКИЙ | **Исправлено в A1+B1:** Все Y=реальные метры (8848 НЕ 88.48). Документация обновлена |
