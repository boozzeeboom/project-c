...
> ⚠️ КРОСС-ЭФФЕКТ (T-SHIP-DOC06 2026-09-18): «двигатель не выключается» ≠ «летает бесплатно» —
> действует `ENGINE_POWER_STATE.md §2.5` (`fuel==0` → авто-OFF → падение, расход как обычно).
> На 10% скоростей та же дистанция стоит ~x10 топлива. Учитывать при балансе.
