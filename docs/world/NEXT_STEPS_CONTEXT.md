...
|---|--------|------|----------|-------------|
| 1 | **B1: VeilSystem** | Облака | Завеса на Y=12, фиолетовая, с молниями | Нет |
| 2 | **B2: Cumulonimbus** | Облака | Вертикальные столбы кумуло-дождевых облаков | B1 |
...
### Шаг 1: B1 — VeilSystem
**Почему:** Не зависит от пиков, ключевая визуальная угроза из книги  
**Что:** Завеса на Y=12, фиолетовый туман, молнии, gameplay предупреждения  
**Файлы:** VeilSystem.cs, VeilMaterial.mat  
**Время:** ~1.5 часа

### Шаг 2: B2 — Cumulonimbus
**Почему:** Зависит от B1, ключевой визуальный элемент из книги  
**Что:** Вертикальные столбы от Y=12 до Y=90+, молнии внутри  
**Файлы:** CumulonimbusCloud.cs  
**Время:** ~2 часа

### Шаг 3: B3 — Обновление слоёв облаков
**Почему:** Зависит от B1, улучшает общую картину  
**Что:** Обновить CloudLayerConfig ассеты под фиксированный мир  
**Файлы:** CloudLayerConfig ассеты  
**Время:** ~1 час
...
**Следующая задача: B1 — VeilSystem**

Создать систему завесы:
- Плоскость на Y=12 с фиолетовым туманом
- Particle System молний
- Gameplay предупреждения при приближении
- Интеграция с AltitudeCorridorSystem

**Файл плана:** docs/world/WorldPrototype_SessionPlan.md §B1

---

**ГОТОВ К ПРОДОЛЖЕНИЮ РАБОТЫ ПО ПЛАНУ.**  
**Следующая задача: B1 — VeilSystem** 🚀
