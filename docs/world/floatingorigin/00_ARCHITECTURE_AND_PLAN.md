...
- Следующая интеграционная часть T-FO04 — concrete global spawn bootstrap, initial frame/pose placement, scene catalog и child lifecycle в согласовании с RPC/persistence, content, physics и nav границами T-FO05–08. Ограниченный baseline-parent слой не заменяет gameplay/native bridges NPC/кораблей. Prefab/scene activation и T-FO05–09 ещё не выполнены. Runtime floating origin не включён, устранение микротряски не подтверждено.
