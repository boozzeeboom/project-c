...
- Следующая ограниченная часть T-FO04 — closed scene catalog и scene-object/child lifecycle contract/provider; полноценные prepared-content/global-persistence источники согласуются с T-FO05–08. Player factory и baseline-parent слой не заменяют gameplay/native bridges NPC/кораблей. Prefab/scene activation и T-FO05–09 ещё не выполнены. Runtime floating origin не включён, устранение микротряски не подтверждено.
