...
- Следующие обязательные части интеграции: trusted persistent identity mapping, transactional repository/backups и authoritative global checkpoint collection для genuine source G; дальнейшая миграция ship/RPC DTO T-FO05. Authoring/baking source bindings, reviewed catalog, spatial/replacement/exclusion/DDOL/loading bridges T-FO06–08 остаются открыты, как и dirty/missing-component/uninspected scope H. I full-preload static/service subset и A persistence codec НЕ завершают native gameplay, MMO streaming или distributed recovery. Prefab/scene activation, полный T-FO04/T-FO05 и T-FO06–09 не приняты. Runtime floating origin выключен, устранение микротряски не подтверждено.
