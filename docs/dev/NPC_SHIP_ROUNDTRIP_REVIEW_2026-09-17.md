...
| Dwell до 5000 с × 20 кораблей на 21 пад = голодание падов | ⚠️ Логика кода подтверждает механику; сами числа — из конфигурации/тестов R11, перепроверить на актуальных Schedule-ассетах |
