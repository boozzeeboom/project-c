...
Hooks are configured in `.QWENCODE/settings.json` and fire automatically:
...
Hook reference documentation: `.QWENCODE/docs/hooks-reference/`
Hook input schema documentation: `.QWENCODE/docs/hooks-reference/hook-input-schemas.md`
