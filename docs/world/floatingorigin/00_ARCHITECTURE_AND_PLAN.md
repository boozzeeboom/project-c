...
- Следующий T-FO04E — согласованные NGO spawn/parent/prefab activation contracts и совместимость layout. Prefab/scene activation и T-FO05–09 ещё не выполнены. Runtime floating origin не включён, устранение микротряски не подтверждено.
