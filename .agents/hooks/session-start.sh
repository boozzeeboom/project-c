#!/bin/bash
# Qwencode SessionStart hook: Load project context at session start
# Outputs context information that Qwencode sees when a session begins
#
# Input schema (SessionStart): No stdin input

echo "=== Qwencode Game Studios — Session Context ==="
