// CloudGhibli_OutlineV4.shader — Ghibli cloud with UV-based silhouette outline
// Detects outline at UV edges (silhouette of the mesh)
// No depth buffer needed, works in Scene View

Shader "ProjectC/CloudGhibli_OutlineV4"
{
    Properties
    {
        [Header(Base Color)]
