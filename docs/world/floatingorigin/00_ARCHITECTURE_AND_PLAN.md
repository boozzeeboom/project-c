...
- Следующий интеграционный фокус: реальный trusted account input и orchestration identity/session/persistence, prepared pilot scope в основном build, catalog/markers/frames, player prefab/layout/profile и retirement legacy loading/writers. Concrete fixed-frame source уже существует, но не настроен/не назначен и не заменяет AOI/streaming, actual native readiness или игровой save lifecycle. Остаются ship/ParentLocal composition, RPC/DTO, disconnect/final-save/respawn, client rebase, multi-region physics/Host, NavMesh/AI, visual/global-height consumers и user acceptance. Полные T-FO04–09 и semantic T-FO03 не закрыты; world shift выключен, jitter fixed не заявляется.
