---
name: setup-engine
description: "Configure the project's game engine and version. Pins the engine in QWENCODE.md, detects knowledge gaps, and populates engine reference docs via WebSearch when the version is beyond the LLM's training data."
...
## 4. Update QWENCODE.md Technology Stack

Read `QWENCODE.md` and update the Technology Stack section. Replace the
...
After updating QWENCODE.md, create or update `.Qwencode/docs/technical-preferences.md` with
...
- Always show the user what you're about to change before making QWENCODE.md edits
