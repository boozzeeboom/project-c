...
| **.meta** | ❌ НЕ трогать .meta файлы — Unity генерирует сам |
| **.asmdef** | ❌ НЕ создавай/изменяй .asmdef без согласования — ломает билд |
| **Кириллица** | ❌ НЕ используй кириллицу/иероглифы в коде — ТОЛЬКО в комментариях |
| **Эмодзи** | ❌ НЕ используй эмодзи в коде, комментариях, переменных |
...
**Версия:** 2.1 | **Обновлено:** 2026-04-15 | + Базовые правила кода (.clinerules/rules/basic-rules.md)
