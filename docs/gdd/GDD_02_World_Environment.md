...
**Версия:** 1.4 | **Дата:** 4 августа 2026 г. | **Статус:** ✅ Документировано + NPC + квестовые зоны + Veil + Day/Night + Wind + SplineWindZone + **Cloud Ocean 3.0** (объёмные облака + штормовые ячейки) реализованы
...
|---|-----|----------|--------|-------------|
| 1 | Примум | Эверест (8848м) | Максимальная | Главный город НП, административный центр, штаб Гильдии Силы |
| 2 | Секунд | К2 (8611м) | Высокая | Штаб Гильдии Мысли (инженерия, физика) |
| 3 | Тертиус | Аконкагуа (6962м) | Средняя | Торговый hub, штаб Гильдии Созидания (химия, медицина) |
| 4 | Квартус | Мак-Кинли (6190м) | Средняя | Научный центр |
...
|-------|----------|-----------|---------|------------------|
| **Примум** | Эверест | ~500,000 | Столица НП | Административный центр, Совет Гильдий, штаб Гильдии Силы (служба безопасности) |
| **Секунд** | К2 | ~200,000 | Инженерный центр | Штаб Гильдии Мысли, конструкторские бюро, полигон |
| **Тертиус** | Аконкагуа | ~350,000 | Торговый hub | Рынок, таможня, хостелы, верфь, штаб Гильдии Созидания (химия, медицина) |
| **Квартус** | Мак-Кинли | ~150,000 | Научный центр | Лаборатории, библиотека, обсерватория |
...
| Гроза | Молнии, гром, ливень | 🟡 **Штормовые ячейки** (`StormCellDirector`, cellular FBM «цветная капуста» + domain warp, иммунны к displacement, runtime save/load) + `LightningBolt.vfx` — прод-интеграция молний в ячейки → v3.5 |
