# QWENCODE.local.md Template

Copy this file to the project root as `QWENCODE.local.md` for personal overrides.
...
- IDE: VS Code with QWENCODE extension
...
1. Copy this template to your project root: `cp .QWENCODE/docs/QWENCODE-local-template.md QWENCODE.local.md`
2. Edit to match your preferences
3. Verify `QWENCODE.local.md` is in `.gitignore` (QWENCODE reads it from the project root)
