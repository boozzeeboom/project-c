...
namespace ProjectC.EditorTools.FloatingOrigin
{
    ...
    public static class ValidateGlobalSceneCatalog
    {
        ...
        {
            return new GlobalSceneCatalogData { expectedSceneGuids = new[] { GuidA }, scenes = new[] { new GlobalSceneSource { sceneGuid = GuidA, assetPath = "Assets/_Project/Scenes/World/WorldScene_0_0.unity", dependencyHash = new string('c', 32), inspectedComplete = true, saved = true,
                ...
                entries = new[] { new GlobalSceneEntry { sceneGuid = GuidA, sourceId = Root, reviewNote = "pure fixture", treatment = GlobalSceneTreatment.SceneNetworkObject, ownership = GlobalSceneOwnership.SceneOwnedNetworkGameplay, spatial = true, poseKind = GlobalScenePoseKind.World, worldPosition = new GlobalPosition(56500, 10, 0) },
                    new GlobalSceneEntry { sceneGuid = GuidA, sourceId = Child, parentSourceId = Root, reviewNote = "pure fixture", treatment = GlobalSceneTreatment.SceneNetworkObject, ownership = GlobalSceneOwnership.SceneOwnedNetworkGameplay, spatial = true, poseKind = GlobalScenePoseKind.ParentLocal, parentLocalPosition = Vector3.one } } };
        }
