...
**Ветка Git:** `qwen-dev`
**Последний коммит:** `7e613fc`
**Версия:** `v0.1.5-prealpha-ship-system`
...
**Версия:** `v0.1.5-prealpha-ship-system` (преальфа — можно играть)

**Схема версионирования:**
- `0.1.x` — преальфа (играбельный прототип)
- `0.2.x` — альфа (сетевой мультиплеер)
- `0.3.x` — бета (контент, баланс)
- `1.0.0` — релиз
