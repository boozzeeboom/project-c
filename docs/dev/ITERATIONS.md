...
## Итерация от 2026-08-24 (T-AURA01)

**Задача:** Исправить проектные инструкции Aura и восстановить рабочий Git-процесс для завершённых этапов задач.
**Коммит:** будет указан после создания коммита этапа.
**Изменения:**
- `.Aura/Skills/README.md` — убраны зависимости от Claude Code/cloud tooling и Unity Git integration; описано версионирование общих Aura skills.
- `.Aura/Skills/git-commit/SKILL.md` — восстановлен пошаговый процесс: поиск правильного тикета в доках, обновление рабочего `ITERATIONS.md`, прямой Git CLI-коммит и фиксация фактического хеша.
- `AGENTS.md` — разрешён прямой ticketed commit после завершения этапа; Unity/MCP не используются для Git.
- `.gitignore` — `.Aura/project.json` остаётся локальным, `.Aura/Skills/**` доступен для Git.
