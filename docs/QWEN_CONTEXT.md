...
**Версия:** `v0.0.11-disconnect-fix` | **Дата:** 5 апреля 2026 г.
**Ветка:** `qwen-gamestudio-agent-dev` (основная) | **Этап:** Ранняя преальфа (прототип ядра)
