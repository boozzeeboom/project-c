...
1. **Read the QWENCODE.md** for project overview and standards.

2. **Read the relevant agent definition** from `.Qwencode/agents/` if a specific
   role is specified.
...
[Summary of conventions relevant to this role from QWENCODE.md and agent definition]
